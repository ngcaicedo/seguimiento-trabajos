...
Planes 01 y 02 implementados y verificados localmente: FastAPI con `/health/live`, configuración explícita, factoría SQLAlchemy/psycopg, estructura modular y seedwork local, pruebas aisladas y paquete instalable.

El modelo puro combina TrabajoCreado y los resultados de Cotizaciones en una vista inmutable. Están pendientes los casos de uso en 03, persistencia/inbox en 04, consumidores en 05 y consultas en 06. La aplicación actual no inicia hilos ni se conecta a Pulsar; configurar una URL solo prepara la factoría SQL, sin ejecutar SQL.
...
114 pruebas cubren la base tecnológica y el modelo: invariantes, ambos órdenes de llegada, duplicados, conflictos, procedencia, revisiones compatibles e importación sin infraestructura. Las 21 pruebas de base se conservan; 93 corresponden al modelo, seedwork y aislamiento. La comprobación de distribución construye sdist y wheel, instala este último sin modo editable e importa desde fuera del árbol fuente. No hay workflow CI.
